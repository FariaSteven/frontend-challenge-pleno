...
const Header = () => {
  ...
  const useStyles = makeStyles(homeStylesConfig(wave, window.screen.width));
  ...
  return (
    ...
    >
      <Grid item xs={5} sm={6} md={6} lg={5} xl={5}>
        <Grid container spacing={3} alignItems="center">
          <Grid item xs={1} sm={3} md={3} lg={4} xl={3}>
      ...
      <Grid item xs={5} sm={6} md={6} lg={5} xl={searchFieldOpen ? 5 : 6}>
        <Grid container spacing={3} alignItems="center">
        { !searchFieldOpen && <Grid item xs={1} sm={1} md={1} lg={5} xl={6}></Grid>}
            {searchFieldOpen && (<Grid item xs={9} sm={8} md={6} lg={5} xl={6}>
          ...
          {!isMobile && <Grid item xs={1} sm={1} md={1} lg={2} xl={1}>
            <div className={classes.headerItems}>
